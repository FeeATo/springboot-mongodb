...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Acordei feliz hoje!", maria); //salva no banco duas cópias diferentes de 'maria', não é uma referência
		
		userRepository.saveAll(Arrays.asList(maria,alex,bob)); //salva no banco
